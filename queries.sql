...
ORDER BY
    income DESC
LIMIT 10;
--запрос возвращает количество строк в таблице sales и суммарную выручку продавца,
--округленную до целого числа, заджойнили, сгруппировали и отсортировали.
...
ORDER BY
    average_income;
--запрос возвращает среднюю выручку продавцов, округленную до целого числа,
--заджойнили, сгруппировали, добавили условия.
...
ORDER BY
    ...
    name;
-- Запрос возвращает день недели, выручку продавцов, округленную
-- до целого числа,заджойнили таблицы, сгруппировали результаты, отсортировали результаты.
